...
var getUserEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userRepo.save(create)];
...
var update = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userRepo.update(id, __assign({}, data))];
            case 1:
                user = _a.sent();
                return [2 /*return*/, user];
        }
...
var del = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userRepo.delete(id)];
            case 1:
                deleteUser = _a.sent();
...
exports.del = del;
var updatePass = function (id, password) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
