...
// import controller
import {createRelive, find_all_relieve, find_one_relieve, update_relieve, delete_relieve, getByRelievingOfficer} from "../controller"
...
route.get('/relieving_officer/officer/:relieveId', authentication, getByRelievingOfficer);
